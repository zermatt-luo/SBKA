...
def prepare_features():
    ...
    zero_loader_ext = DataLoader(dataset=tuberlin_zero_ext, batch_size=args.batch_size, shuffle=False, num_workers=0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume_dir', '-s', metavar='DIR', default='../checkpoint/tuberlin')
